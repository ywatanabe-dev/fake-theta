...
describe('POST /osc/commands/execute _setAccessPoint', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({
        name: 'camera._setAccessPoint',
        parameters: { ssid: 'dummy', security: 'none' },
      })
      .expect(200);
...
describe('THETA X POST /osc/commands/execute _setAccessPoint', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({
...
describe('THETA Z1 POST /osc/commands/execute _setAccessPoint', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({
...
describe('Unknown Type POST /osc/commands/execute _setAccessPoint', () => {

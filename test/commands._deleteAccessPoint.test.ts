...
describe('THETA X POST /osc/commands/execute _deleteAccessPoint', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({
...
describe('THETA Z1 POST /osc/commands/execute _deleteAccessPoint', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({
...
describe('Unknown Type POST /osc/commands/execute _deleteAccessPoint', () => {

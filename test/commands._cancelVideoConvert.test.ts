...
describe('POST /osc/commands/execute _cancelVideoConvert', () => {
...
describe('THETA X POST /osc/commands/execute _cancelVideoConvert', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({ name: 'camera._cancelVideoConvert' })
...
describe('THETA Z1 POST /osc/commands/execute _cancelVideoConvert', () => {
  it('should respond with results', async () => {
    const res = await request()
      .post('/osc/commands/execute')
      .send({ name: 'camera._cancelVideoConvert' })
...
describe('Unknown Type POST /osc/commands/execute _cancelVideoConvert', () => {
